// Swallow - Content Script: Persistent Top Bar (Shadow DOM approach)
...
(function () {
  ...
  function injectBar(settings) {
    ...
    // Create host element (outside shadow DOM, in the real page)
    ...
    // Because transform creates a new containing block, fixed elements become relative to body
